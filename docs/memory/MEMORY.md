...
| [product-family-architecture.md](product-family-architecture.md) | The three-tier VistA/M tool family; sibling-effort plans captured in `docs/guides/planning-guide.md` until their repos exist |
